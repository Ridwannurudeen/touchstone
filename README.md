...
**Eleven reports have been published — six of them `CONFIRMED`.** The system refused a
...
genuine on-chain revert. Every report's bundle verifies offline; nine of eleven are
downloadable from the dossier and the two gaps are stated there plainly.
